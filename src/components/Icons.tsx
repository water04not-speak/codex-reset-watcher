...
export function IconTicket({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M3 8h18v3a2 2 0 0 1 0 4v3H3v-3a2 2 0 0 1 0-4V8z" />
...
export function IconWindow5h({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconWindow7d({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
